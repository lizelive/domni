...
use crate::structure::{
    ...
    MaleOrFemaleEnum, MaterialStateEnum, MaterialTokenArg, NoneEnum, PersonalityTraitEnum,
...
pub struct CreatureToken {
    ...
    #[serde(alias = "APPLY_CURRENT_CREATURE_VARIATION")]
    ...
    #[serde(alias = "CV_ADD_TAG", alias = "CV_NEW_TAG")]
