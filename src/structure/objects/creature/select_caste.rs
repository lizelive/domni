...
use crate::structure::{
    AlertOrPeacefulIntermittentEnum, Attack, BiomeEnum, BodyAppearanceModifier, BodyAttributeEnum,
    ...
    LocalMaterialToken, LocalTissueToken, MaleOrFemaleEnum, MaterialStateEnum, MaterialTokenArg,
    NoBuildUpEnum, NoneEnum, PersonalityTraitEnum, PlantOrCreatureTokenArg, SecretionTriggerEnum,
    SelectMaterial, SelectTissue, SelectTissueLayer, SetBpGroup, SetTlGroup, SkillEnum,
    SoulAttributeEnum, SphereEnum, TestAllEnum, TissueLayer, UnitTypeEnum, UseMaterial,
...
pub struct SelectCaste {
    ...
    #[serde(alias = "SELECT_CASTE")]
    pub reference: Option<Reference>,
    // region: Unique to `[SELECT_CASTE:..]` ======================================================
    /// Adds an additional previously defined caste to the selection (so you may alter 2 castes at once).
    #[serde(alias = "SELECT_ADDITIONAL_CASTE")]
    pub select_additional_caste: Vec<Reference>,
    // endregion ==================================================================================
    ...
    // TODO: only allow these creature-only tokens if the value is `SELECT_CASTE:ALL`
    // Note, CASTE and SELECT_CASTE have been removed from this region to prevent weird nesting
    ...
    #[serde(alias = "DOES_NOT_EXIST")] // TODO maybe add a warning for this token? like #84
    pub does_not_exist: Flag,
    ...
    /// regardless of caste.
    #[serde(alias = "GENERAL_CHILD_NAME")]
    ...
    #[serde(alias = "GENERATED")] // TODO mark generated, see #84
    pub generated: Flag,
    /// The colour of the creature's `[GLOWTILE]`.
    #[serde(alias = "GLOWCOLOR")]
    ...
    /// angel is associated.
    #[serde(alias = "HFID")] // TODO mark generated,  see #84
    pub hfid: Option<u32>,
    /// What product is harvested from beekeeping.
    #[serde(alias = "HIVE_PRODUCT")]
    pub hive_product: Vec<(u32, u32, ItemReferenceArg, MaterialTokenArg)>,
    /// Creature can spawn as a wild animal in the appropriate biomes.
    #[serde(alias = "LARGE_ROAMING")]
    pub large_roaming: Flag,
